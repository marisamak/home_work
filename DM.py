...
canvas = Canvas(window, width = game_width, height = game_height, background = 'white')
...
text_status_id = canvas.create_text(x1, game_height - 50, anchor = SW, font = ('Arial','25'), text = 'Вперёд!')
